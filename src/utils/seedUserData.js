...
export async function seedUserData(userId) {
  ...
  const sde = [
    ...
    { day: 'push_b', ex: 'Standing Barbell OHP',            sid: 'pb_ohp',      type: 'straight', sets: 3, min: 8,  max: 10, order: 4 },
    ...
    { day: 'pull_a', ex: 'Suitcase Carry',                    sid: 'pla_suitcase',type: 'straight', sets: 2, min: 20, max: 20, order: 9,  note: '/side, walking (anti-rotation core)' },
