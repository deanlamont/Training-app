...
export async function seedUserData(userId) {
  ...
  const sde = [
    ...
    { day: 'push_a', ex: 'Arsenal Fly Machine',             sid: 'pa_fly',      type: 'straight', sets: 3, min: 12, max: 15, order: 4,  intensifier: 'Slow 3s eccentric + peak squeeze' },
    ...
    { day: 'push_b', ex: 'Arsenal Fly Machine',             sid: 'pb_fly',      type: 'straight', sets: 3, min: 12, max: 15, order: 4,  intensifier: 'Slow 3s eccentric + peak squeeze' },
    ...
    { day: 'pull_b', ex: 'Kettlebell Swing',                    sid: 'plb_kb',       type: 'straight', sets: 3, min: 15, max: 20, order: 9, note: 'conditioning finisher' },
    ...
    { day: 'day_5', ex: 'Kettlebell Swing',               sid: 'd5_kb',        type: 'straight', sets: 3, min: 15, max: 20, order: 8, note: 'conditioning finisher' },
  ];
  ...
  const cycle4Targets = [
    ...
    { day: 'push_a', ex: 'Arsenal Fly Machine',            w: 30,   sets: 3, min: 12, max: 15, rir: 1, type: 'straight' },
    ...
    { day: 'push_b', ex: 'Arsenal Fly Machine',            w: 30,   sets: 3, min: 12, max: 15, rir: 1, type: 'straight' },
    ...
    { day: 'pull_a', ex: 'Cable Lat Prayers',                 w: 58.5, sets: 3, min: 12, max: 15, rir: 1, type: 'straight' },
