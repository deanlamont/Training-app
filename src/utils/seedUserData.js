...
export async function seedUserData(userId) {
  const splitDays = [
    ...
    // Alternate 3-day full-body split — combines Push A/B + Pull A/B for weeks
    // with only 3 available lifting slots (e.g. tennis-heavy weeks). Same
    // weights/reps as the 4-day days, just redistributed. Coexists with the
    // 4-day split; pick whichever set of days you open that week.
    { day_key: 'full_body_1', day_label: 'Full Body 1', subtitle: 'Incline · Vertical Pull · Quads',           sort_order: 6, current_week: 4 },
    { day_key: 'full_body_2', day_label: 'Full Body 2', subtitle: 'Flat · Horizontal Pull · Hamstrings',       sort_order: 7, current_week: 4 },
    { day_key: 'full_body_3', day_label: 'Full Body 3', subtitle: 'DB Chest · Vertical Pull · Quads + Posterior', sort_order: 8, current_week: 4 },
  ];
  ...
  const sde = [
    ...
    { day: 'push_b', ex: 'Nautilus PL Seated Press',        sid: 'pb_seat_pr',  type: 'straight', sets: 3, min: 8,  max: 10, order: 4, note: '/side' },
    ...
    { day: 'full_body_1', ex: 'Pull-up',                        sid: 'fb1_pullup',   type: 'straight', sets: 3, min: 5,  max: 10, order: 2, note: 'bodyweight (+/- assist)' },
    { day: 'full_body_1', ex: 'Nautilus Lat Pulldown overhand', sid: 'fb1_pd_over',  type: 'straight', sets: 3, min: 8,  max: 10, order: 3, note: 'or close-grip V-handle for rear delt bias' },
    { day: 'full_body_1', ex: 'Nautilus PL Seated Press',       sid: 'fb1_seat_pr',  type: 'straight', sets: 3, min: 10, max: 10, order: 4, note: '/side' },
    { day: 'full_body_1', ex: 'Cable Face Pulls',               sid: 'fb1_fp',       type: 'straight', sets: 3, min: 15, max: 20, order: 5, intensifier: '1s pause + squeeze at peak' },
    { day: 'full_body_1', ex: 'Cable Curls',                    sid: 'fb1_cc',       type: 'straight', sets: 3, min: 12, max: 15, order: 6, intensifier: 'Slow 3s eccentric + peak squeeze' },
    { day: 'full_body_1', ex: 'Cable Rope Overhead Extension',  sid: 'fb1_rope_oh',  type: 'straight', sets: 3, min: 12, max: 12, order: 7 },
    { day: 'full_body_1', ex: 'Bulgarian Split Squat',          sid: 'fb1_bulg',     type: 'straight', sets: 3, min: 8,  max: 10, order: 8, note: '/leg. Rear foot elevated on bench. Front shin vertical, drop straight down. Bodyweight to start, add DBs as it gets easy.' },
    { day: 'full_body_1', ex: 'Nautilus Leg Extensions',        sid: 'fb1_leg_ext',  type: 'chipper',  sets: null, min: 60, max: 60, order: 9, note: 'controlled reps only — no kicking the stack up', intensifier: 'Slow 3s eccentric + 1s squeeze at top' },
    ...
    { day: 'full_body_2', ex: 'DB Flat Bench',                  sid: 'fb2_db_flat',  type: 'straight', sets: 3, min: 10, max: 12, order: 2 },
    { day: 'full_body_2', ex: 'Nautilus Seated Row V-bar',      sid: 'fb2_row_vbar', type: 'straight', sets: 3, min: 10, max: 12, order: 3 },
    { day: 'full_body_2', ex: 'Arsenal Lateral Raises',         sid: 'fb2_lat_r',    type: 'straight', sets: 3, min: 12, max: 15, order: 4, intensifier: 'Slow 3s eccentric + 1s pause at top' },
    { day: 'full_body_2', ex: 'Incline DB Curls',               sid: 'fb2_inc_curl', type: 'straight', sets: 3, min: 12, max: 15, order: 5, intensifier: 'Slow 3s eccentric (deep stretch)' },
    { day: 'full_body_2', ex: 'Dips with Knee Raise',           sid: 'fb2_dips',     type: 'straight', sets: 3, min: 8,  max: 12, order: 6 },
    { day: 'full_body_2', ex: 'Romanian Deadlift',              sid: 'fb2_rdl',      type: 'straight', sets: 3, min: 8,  max: 8,  order: 7 },
    { day: 'full_body_2', ex: 'Hip Thrust',                     sid: 'fb2_thrust',   type: 'chipper',  sets: null, min: 50, max: 50, order: 8, note: 'full lockout every rep — no half reps as fatigue builds', intensifier: '2s pause + squeeze at top' },
    { day: 'full_body_2', ex: 'Chabbles Workout',               sid: 'fb2_chabbles', type: 'straight', sets: 3, min: 10, max: 10, order: 9 },
    ...
    { day: 'full_body_3', ex: 'Nautilus Chest Supported Row High', sid: 'fb3_row_high', type: 'straight', sets: 3, min: 10, max: 15, order: 3 },
    { day: 'full_body_3', ex: 'Nautilus PL Seated Press',       sid: 'fb3_seat_pr',   type: 'straight', sets: 3, min: 8,  max: 10, order: 4, note: '/side' },
...
https://youtu.be/utBzlEiX-zA` },
  ...
  const cycle4Targets = [
    ...
    { day: 'push_b', ex: 'Nautilus PL Seated Press',       w: 60,   sets: 3, min: 8,  max: 10, rir: 2, type: 'straight' },
    { day: 'push_b', ex: 'Arsenal Lateral Raises',         w: 40,   sets: 3, min: 12, max: 15, rir: 1, type: 'straight' },
    ...
    { day: 'pull_a', ex: 'Cable Face Pulls',                  w: 58.5, sets: 3, min: 15, max: 20, rir: 1, type: 'straight' },
    ...
    { day: 'pull_b', ex: 'Cable Curls',                        w: 43,   sets: 3, min: 12, max: 12, rir: 2, type: 'straight' },
    ...
    { day: 'full_body_1', ex: 'Pull-up',                        w: 0,    sets: 3, min: 5,  max: 10, rir: 2, type: 'straight' },
    ...
    { day: 'full_body_2', ex: 'DB Flat Bench',                  w: 70,   sets: 3, min: 10, max: 12, rir: 2, type: 'straight' },
    ...
    { day: 'full_body_3', ex: 'Nautilus Chest Supported Row High', w: 55, sets: 3, min: 10, max: 15, rir: 2, type: 'straight' },
